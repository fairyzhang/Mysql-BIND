...
query_find(ns_client_t *client, dns_fetchevent_t *event, dns_rdatatype_t qtype)
{
	...
	dns_clientinfomethods_t cm;
	dns_clientinfo_t ci;
	isc_boolean_t mysqldb_notconnected = 0;
 ...
 resume:
	...
	switch (result) {
    case ISC_R_MYSQLDBNOTCONNECT:
        mysqldb_notconnected = 1;
        goto cleanup;
	case ISC_R_SUCCESS:
		/*
